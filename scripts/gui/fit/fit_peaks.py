...
def main(raw_args=None):
    ...
    for idx,i in enumerate(peak_pos):
        ...
        try:
            ...
            x_lin=numpy.hstack((numpy.arange(peak_range[idx][0],peak_range[idx][0]),numpy.arange(peak_range[idx][1],peak_range[idx][1])))

            #print('y',y_lin,y_lin.shape)
            #print('x',x_lin,x_lin.shape)
            ...
            #plt.plot(rad_x[xi:xf],rad_ave_mask[xi:xf])
            ...
            #print('hey',rad_sub)
            #plt.plot(x,rad_sub,'r',label='sub')
            #plt.show()
