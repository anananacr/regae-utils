...
class App(QWidget):
    def __init__(self):
        ...
        self.setWindowIcon(QIcon('./regae.png')) 
    ...
    def createTable(self):
        ...
        contents=[["Pedestal date:","20221114_0"],["Raw files date:","20221114"],["Raw files path:","/asap3/fs-bmx/gpfs/regae/2022/data/11016614/raw/Au_free_mag"],["Sample label:","Au"],["Total number of shots per file:","100"],["Number of shots to accumulate:","100"],["Pump and probe zero delay (mm):","0"],["First file index:","0"],["First file scan stage (mm/A):","0"],["Last file index:","12"],["Last file scan stage (mm/A):","2.4"], ["Scan stage step (mm/A):","0.2"]]
    ...
    def _run_button_clicked(self) -> None:
        ...
        status=convert_images.run(args)
