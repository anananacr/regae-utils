...
def main(raw_args=None):
    ...
    parser.add_argument("-n", "--n_edge", type=int, action="store",
    ...
    max_resolution_in_a=lambda_ / (2.0 *np.sin(0.5*np.arctan2(_pixel_detector_edge,_last_detector_distance*_last_pixel_size)))
